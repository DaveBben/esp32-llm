...
EventGroupHandle_t StartMatMUL;

static const char *TAG = "LLM";
TaskHandle_t matmul_task_1 = NULL;
TaskHandle_t matmul_task_2 = NULL;

TaskParams *params1 = NULL;
TaskParams *params2 = NULL;

SemaphoreHandle_t semaphore_one, semaphore_two;
...
void build_transformer(Transformer *t, char *checkpoint_path)
{
    ...
    // params1 = malloc(sizeof(TaskParams));
    params2 = malloc(sizeof(TaskParams));

    // params1->task_wait = 1;
    params2->task_wait = 1;

    // xTaskCreatePinnedToCore(matmul_task, "MatMul1", 2048, params1, 19, &matmul_task_1, 1); // Run on Core 1
    xTaskCreatePinnedToCore(matmul_task, "MatMul2", 2048, params2, 19, &matmul_task_2, 1); // Run on Core 0
...
{
    *params2 = (TaskParams){xout, x, w, d / 2, d, n, d, TASK_1_BIT, 0};
    for (int i = 0; i < d / 2; i++)
    {
        float val = 0.0f;
        for (int j = 0; j < n; j++)
